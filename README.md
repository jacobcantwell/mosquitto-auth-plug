...
This fork of the `mosquitto-auth-plug`, orginally created by jpmens here `jpmens/mosquitto-auth-plug`, will focus on improving the access control capabilities of the Eclipse Mosquitto lightweight MQTT message broker.
